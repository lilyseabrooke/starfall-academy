...
export function computeCompendiumGrant(
  ...
  switch (e.cat) {
    case "spell": {
      ...
      return { field: "spells", value: [...prev, { id, name: e.name, level: e.level, subjectKey: e.subjectKey || "", subject: e.subject || "", school: e.school || "", stat: e.stat || "", ap: e.ap || 0, dc: e.dc ?? null, ritual: !!e.ritual, volatile: !!e.volatile, days: 0, desc: e.desc, higherLevel: e.higherLevel }] };
    }
    case "artifact": {
...
export function computeLearningSpellGrant(e: CompendiumEntry, currentSpells: Spell[]): { field: "spells"; value: Spell[] } | null {
  ...
  return { field: "spells", value: [...currentSpells, { id: "sp-comp-" + e.id, name: e.name, level: e.level, subjectKey: e.subjectKey || "", subject: e.subject || "", school: e.school || "", stat: e.stat || "", ap: e.ap || 0, dc: e.dc ?? null, ritual: !!e.ritual, volatile: !!e.volatile, days: learnDaysFor(e.level), desc: e.desc, higherLevel: e.higherLevel }] };
}
