...
export const TYPES: BonusTypeMeta[] = [
  ...
  { id: "spell", label: "A specific spell", group: "Totals", target: "req", kind: "spell", icon: "wand-sparkles", hint: "Adds to one spell's casting roll." },
  ...
  { id: "artifact-repair", label: "Artifact repair rolls", group: "Rolls", target: "none", icon: "cog", hint: "Every artifact repair roll." },
  ...
  { id: "artificybackfire", label: "Artificy backfire rolls", group: "Rolls", target: "none", icon: "heart-crack", hint: "Every artificy backfire roll." },
  { id: "wandcraft", label: "Wandcraft rolls", group: "Rolls", target: "none", icon: "hammer", hint: "Every wandcraft roll." },
